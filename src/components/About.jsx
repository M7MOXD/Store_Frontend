...
export default function About() {
  return <div>
    <div className="container text-center m-5">
      <p>At <span className='lead fw-bolder text-success'>THE STORE</span>, our aim is to offer you the  <span className='fw-bolder lead'>BEST</span> products that show you that we really care! Not only have we got the trendiest, but we can also guarantee that they are of the finest quality.
